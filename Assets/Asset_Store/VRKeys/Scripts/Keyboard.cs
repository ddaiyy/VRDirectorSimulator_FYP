...
namespace VRKeys {
	...
	public class Keyboard : MonoBehaviour {
        [Header("Override hand transforms")]
        public Transform overrideLeftHand;
        public Transform overrideRightHand;
        ...
        private void Update()
        {
            if (overrideLeftHand != null)
            {
                leftHand.transform.position = overrideLeftHand.position;
                leftHand.transform.rotation = overrideLeftHand.rotation;
            }
            else
            {
                leftHand.transform.localPosition = InputTracking.GetLocalPosition(XRNode.LeftHand);
            ...
            if (overrideRightHand != null)
            {
                rightHand.transform.position = overrideRightHand.position;
                rightHand.transform.rotation = overrideRightHand.rotation;
            }
            else
            {
                rightHand.transform.localPosition = InputTracking.GetLocalPosition(XRNode.RightHand);
