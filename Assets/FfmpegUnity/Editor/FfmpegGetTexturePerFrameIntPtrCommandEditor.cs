...
{
    [CustomEditor(typeof(FfmpegGetTexturePerFrameIntPtrCommand))]
    public class FfmpegGetTexturePerFrameIntPtrCommandEditor : Editor
    {
        public override void OnInspectorGUI()
        {
            ...
            var ffmpegPlayerCommand = (FfmpegGetTexturePerFrameIntPtrCommand)target;
