...
namespace FfmpegUnity
{
    public class BuildProcessor : IPreprocessBuildWithReport, IPostprocessBuildWithReport
    {
        ...
        public static void OnPostProcessBuild(BuildTarget buildTarget, string path)
        {
            ...
            File.Copy(Application.dataPath + "/FfmpegUnity/Plugins/libopenh264-arm64.dylib", Path.GetDirectoryName(bundlePath) + "/libopenh264-arm64.dylib");
            File.Copy(Application.dataPath + "/FfmpegUnity/Plugins/libopenh264-x64.dylib", Path.GetDirectoryName(bundlePath) + "/libopenh264-x64.dylib");
#endif
        }
    }
}
